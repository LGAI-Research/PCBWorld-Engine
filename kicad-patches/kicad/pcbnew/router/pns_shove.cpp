                                ...
                                bool aPermitAdjustingEnd )
{
    ...
    for( attempt = 0; attempt < 2; attempt++ )
    {
        ...
        if( permitAdjustingEndpoints && l_base.SegmentCount() >= 1 )
        {
            ...
            VECTOR2I p1 = minDistP( l_base.CPoint( -1 ), minDist1, minhull1 );
